...
<%-- book Add/Edit logic --%>
	...
	<c:if test="${requestScope.person ne null}">
		<form action='<c:out value="${editURL}"></c:out>' method="post">
			ID : <input type="text" value="${requestScope.person.id}" readonly="readonly" name="id">
			<br>
			이름 : <input	type="text" value="${requestScope.person.name}" name="name">
			<br>
			작가 : <input type="text" value="${requestScope.person.country}" name="country">
			<br>
